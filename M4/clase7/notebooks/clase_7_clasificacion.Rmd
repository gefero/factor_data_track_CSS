...
## Dado que tarda unos 15 minutos en entrenar, tenemos tuneo ya persistido en una carpeta.
...
#write_rds(tune_lasso_idf, 
#          '../models/tune_lasso_idf.rds')
...
### Carga del embedding
Vamos a usar un embedding entrenado mediante el algoritmo wor2vec por C. Cardelino. Está entrenado sobre un corpus grande en español. Pueden encontrar los detalles [aquí](https://crscardellino.net/SBWCE/). Pueden descargar el archivo binario desde [acá](https://cs.famaf.unc.edu.ar/~ccardellino/SBWCE/SBW-vectors-300-min5.bin.gz)
