...
### Clases 10 a 14. Desarrollo del Trabajo Final Integrador
- [Consignas](./clase10_TFI/2025/2025_tp_final.html)
- [Dataset](./clase10_TFI/2025/df_date_filtered_lang_final.csv)

[![](../imgs/Download.png)](./clase10_TFI/2025/clase10_tfi.zip)

### Clase 9. Transformers y LLM's E2. Usando LLMs de forma local
- [Tutorial en YouTube: Introducción a Google Colab](https://youtube.com/playlist?list=PLbECkNOVKUKP401fJbWRe8r-z4L4-OvM8&si=h9FO4wW_SL7jEdzk)
- [Explicación - LLMs locales usando `ollama` y `ollamar`](https://colab.research.google.com/drive/1Vv4imSVOXH6GJ4m_CXq81d_gF9PDDA0b?usp=sharing)
- [Sitio de ollama](https://ollama.com/)
- [Sitio de ollamar](https://hauselin.github.io/ollama-r/)
