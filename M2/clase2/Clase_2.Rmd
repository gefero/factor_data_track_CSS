...
El intercepto ($\beta_{0}$) en este caso es el peso promedio cuando `male==0`; es decir, el peso promedio cuando el caso NO es varón. La pendiente ($\beta_{1}$) significa que si el caso es varón entonces, debo sumarle al promedio 6.778 kg. Es decir, que los varones son en promedio 6.77kg. más pasados que les no varones.
...
Hemos descrito los matices del modelo lineal. Hemos aprendido a crear un modelo lineal con variables explicativas que son numéricas y categóricas. 
