...
for (i in 1:reps){
  boot <- df %>%
          ...
          group_by(region) %>%
          mutate(n_sample = n()) %>%
          sample_n(n_sample[1],  weight = f_calib3, replace=TRUE)
