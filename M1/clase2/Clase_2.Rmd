...
```{r}
df_2 <- get_microdata(year=2020, trimester=2, type='hogar') %>%
        organize_labels(type='hogar')

df_2 <- df_2 %>%
    select(CODUSU, IX_TOT:IX_MAYEQ10) # Selecciono únicamente las variables de ID y las variables de resumen del hogar 
