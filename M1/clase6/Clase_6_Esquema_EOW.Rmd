...
### Empleadores
Para la construcción de la categoría **empleadores** (ver esquema de Wright 1974 pp. 242-247) se siguieron los siguientes criterios
...
Finalmente, podemos salvar el nuevo dataset mediante `write_rds()`
```{r}
...
## Ejercicio
A partir de la tabla 1 (más arriba) construir nuevamente la tipología de clases 
de Erik Olin Wright pero usando cinco variables dicotómicas.
