...
- Entrega vía Google Classroom: [link para acceder al classroom](https://classroom.google.com/c/Nzk4MjMyOTcwNjM1?cjc=4rufgcmw) 
...
## Programa
- [Programa de la materia - 1er. cuatrimestre 2026](https://docs.google.com/document/d/1Fe3e2h6806euTQXUKYqg34YGMrddIObUzEE9DXxRpqw/edit?usp=sharing)

## Instructivo de instalación
- [¿Cómo instalar R y RStudio](https://docs.google.com/document/d/1KCKz-z9_LT4HXIfXVZL45em8_1RMv6SLZdZ4u97M9_Q/edit?tab=t.0)
...
- [Práctica Independiente Soluciones - RMarkdown](./clase1/Clase_1_practica_soluciones.R)
...
- [Práctica Independiente Soluciones - RMarkdown](./clase2/Clase_2_practica_soluciones.R)
...
- [Práctica independiente Soluciones - RScript](./clase4/Clase_4_practica_independiente_soluciones.R)
...
Pueden descargarse la totalidad de los materiales del repositorio para trabajar en un único archivo .zip
[![](./imgs/Download.png)](./clase7.zip)


## Clases 8 y 9. Introducción a Bootstrap
- [Slides - Notebook](./clase8_9/M1_Clase_8.pdf)
- [Script - Ejercicio de construcción de distribución muestral](./clase8_9/Distribuciones_muestrales.R) 
...
Pueden descargarse la totalidad de los materiales del repositorio para trabajar en un único archivo .zip
[![](./imgs/Download.png)](./clase8_9.zip)
