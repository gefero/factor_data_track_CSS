...
### Actividad
Calculen el chi cuadrado de la misma tabla pero ponderada con los valores expandidos a la población. ¿Qué ocurre con el valor de $\chi^2$?
```{r}
###
```
...
Dado que no se encuentra implementado en R de forma simple, hemos escrito un función muy simple para hacer el cálculo. La misma toma como input una tabla (al ogu)
